...
void update_layer_rgb_color(void) {
    switch (get_highest_layer(layer_state)) {
        case 1: rgblight_sethsv(0, 255, 255); break;    // 赤
        case 2: rgblight_sethsv(85, 255, 255); break;   // 緑
        case 3: rgblight_sethsv(32, 255, 255); break;   // オレンジ
        default: rgblight_sethsv(170, 255, 255); break; // 青
    }
}
...
void matrix_scan_user(void) {
    ...
    if (get_highest_layer(layer_state) == 1) {
        ...
        rgblight_sethsv(0, 255, breath_v);  // 赤色 呼吸
    } else {
        update_layer_rgb_color();
    }
}
